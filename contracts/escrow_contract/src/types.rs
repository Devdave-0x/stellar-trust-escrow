...
pub enum DataKey {
    ...
    ContractVersion,
    /// Terms acceptance record for an escrow — key: u64, value: TermsAcceptance
    TermsAcceptance(u64),
    /// DEX configuration — value: DexConfig
    DexConfig,
    /// DEX swap record for an escrow — key: u64, value: DexSwapRecord
    DexSwapRecord(u64),
}
