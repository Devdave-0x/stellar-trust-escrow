...
pub use types::{
    ApprovalRecord, ContractVersionInfo, DataKey, DisputeEvidence, EscrowFeeSnapshot,
    EscrowState, EscrowStatus, EscrowTemplate, FeeTier, Milestone, MilestoneStatus,
    MilestoneTemplate, MultisigConfig, OptionalBytesN32, OptionalPriceCondition,
    OptionalTimelock, OracleResolutionPayload, PriceCondition, PriceDirection,
    RecurringInterval, RecurringScheduleStatus, ReputationRecord, Timelock,
...
pub struct EscrowMeta {
    ...
    /// Arbiter fee in basis points (0-10000). Deducted from the total
    /// fee when a dispute is resolved and paid to the assigned arbiter.
